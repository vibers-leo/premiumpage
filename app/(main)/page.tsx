...
const portfolios = [
  {
    ...
    links: [
      { label: '영문 사이트 열기', url: 'https://emt.premiumpage.kr', primary: true },
      { label: '한국어 사이트 열기', url: 'https://emt-ko.premiumpage.kr', primary: false },
    ],
    featured: true,
  },
  {
    ...
    links: [
      { label: '영문 사이트 열기', url: 'https://hstech.premiumpage.kr', primary: true },
      { label: '한국어 사이트 열기', url: 'https://hstech-kr.premiumpage.kr', primary: false },
    ],
    featured: true,
  },
  {
    ...
    links: [
      { label: '사이트 열기', url: 'https://hstechco.premiumpage.kr', primary: true },
    ],
    featured: false,
  },
  {
    ...
    links: [
      { label: '사이트 열기', url: 'https://gentop.premiumpage.kr', primary: true },
    ],
    featured: false,
  },
  {
    ...
    links: [
      { label: '사이트 열기', url: 'https://hangseong.premiumpage.kr', primary: true },
    ],
    featured: false,
  },
]
