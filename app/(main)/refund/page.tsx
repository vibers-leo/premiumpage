    ...
    <main className="min-h-screen bg-white text-neutral-900">
      <div className="max-w-3xl mx-auto px-6 py-16 md:py-24">
        <div className="mb-12">
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight">취소 및 환불 정책</h1>
          <p className="text-sm text-neutral-400 mt-3">시행일자: 2026년 4월 9일</p>
        </div>

        <div className="mb-10 p-6 bg-neutral-950 border border-neutral-800">
          <p className="text-base leading-relaxed font-medium text-neutral-200">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-neutral-50 border border-neutral-200">
              ...
              <p className="text-neutral-500 text-sm">결제 완료 후 작업 착수 전 취소 요청 시 전액 환불</p>
              <p className="text-xs text-neutral-400 mt-1">※ 통상 결제 후 1영업일 이내 작업 착수</p>
            </div>
            <div className="p-4 bg-neutral-50 border border-neutral-200">
              <h3 className="font-bold mb-2">부분 환불</h3>
              <p className="text-neutral-500 text-sm mb-2">작업 착수 후 취소 요청 시 진행률에 따라 환불</p>
              <ul className="list-disc list-inside space-y-1 ml-4 text-sm text-neutral-500">
                <li>기획·구성 단계 (30% 진행): 결제금액의 70% 환불</li>
                <li>디자인 단계 (60% 진행): 결제금액의 40% 환불</li>
                <li>개발·완료 단계 (100% 진행): 환불 불가</li>
              </ul>
            </div>
            <div className="p-4 bg-neutral-50 border-l-2 border-l-neutral-900 border border-neutral-200">
              <h3 className="font-bold mb-2">환불 불가</h3>
              <ul className="list-disc list-inside space-y-1 ml-4 text-sm text-neutral-500">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-3 text-neutral-500 leading-relaxed">
            <p>• 월 유지보수 구독은 다음 결제일 <strong className="text-neutral-900">7일 전</strong>까지 해지 요청 시 다음 달부터 청구되지 않습니다.</p>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-3 text-neutral-500 leading-relaxed">
            ...
            <p>② 환불 결정 후 영업일 기준 <strong className="text-neutral-900">3~5일</strong> 이내 처리됩니다.</p>
