    ...
    <main className="min-h-screen bg-white text-neutral-900">
      <div className="max-w-3xl mx-auto px-6 py-16 md:py-24">
        <div className="mb-12">
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight">이용약관</h1>
        ...
        <section className="mb-10">
          ...
          <ul className="list-decimal list-inside space-y-2 ml-4 text-neutral-500 leading-relaxed">
        ...
        <section className="mb-10 pt-8 border-t border-neutral-200">
          ...
          <p className="text-neutral-500">본 약관은 2026년 4월 9일부터 시행됩니다.</p>
        </section>
