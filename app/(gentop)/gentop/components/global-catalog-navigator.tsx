        ...
        <div className={cn(
            ...
            <div className="pointer-events-auto flex items-center justify-between gap-6 md:gap-16 bg-background/80 backdrop-blur-md border border-border/50 px-6 py-3 rounded-full shadow-2xl transition-all duration-300 hover:scale-105 hover:bg-background/90 hover:border-gentop-green/30">
                ...
                {prevPage ? (
                    <Link
                        href={prevPage}
                        className="group flex items-center gap-2 text-sm md:text-base font-medium text-muted-foreground hover:text-gentop-green transition-all duration-300"
                    >
                        <div className="p-1.5 md:p-2 rounded-full border border-border group-hover:border-gentop-green group-hover:bg-gentop-green/10 transition-all duration-300">
                            <ChevronLeft size={18} className="md:w-5 md:h-5" />
                        </div>
                        <span className="hidden md:inline font-bold">Prev</span>
                    </Link>
                ) : (
                    <div className="w-[42px] md:w-[70px]" />
                )}
