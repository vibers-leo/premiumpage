...
interface BackgroundBeamsProps {
    className?: string;
    beamColor?: string; // Customizable beam color (CSS color)
}

export const BackgroundBeams = ({
    className,
    beamColor = "rgba(173, 232, 19, 0.15)",
    ...
    useEffect(() => {
        ...
        const draw = () => {
            ...
            paths.forEach((path) => {
                ...
                gradient.addColorStop(0, "rgba(173, 232, 19, 0)");
                gradient.addColorStop(0.5, beamColor);
                gradient.addColorStop(1, "rgba(173, 232, 19, 0)");
