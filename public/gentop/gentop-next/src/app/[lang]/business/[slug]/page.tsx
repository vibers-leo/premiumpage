...
import { ConstructionElectric } from '@/components/business/construction-electric';
import { ConstructionMachine } from '@/components/business/construction-machine';
import { ConstructionInfo } from '@/components/business/construction-info';
import { ConstructionTabs } from '@/components/business/construction-tabs';
import { EcoFriendlyTabs } from '@/components/business/eco-friendly-tabs';
import { EcoFriendlySolar } from '@/components/business/eco-friendly-solar';
import { EcoFriendlyGeothermal } from '@/components/business/eco-friendly-geothermal';
import { EcoFriendlyWind } from '@/components/business/eco-friendly-wind';
import { EcoFriendlyWater } from '@/components/business/eco-friendly-water';
import { AccessTabs } from '@/components/business/access-parking/access-tabs';
import { AccessControl } from '@/components/business/access-parking/access-control';
import { ParkingControl } from '@/components/business/access-parking/parking-control';
import { CCTVTabs } from '@/components/business/cctv/cctv-tabs';
import { CCTVBidirectional } from '@/components/business/cctv/cctv-bidirectional';
import { CCTVUnmanned } from '@/components/business/cctv/cctv-unmanned';
